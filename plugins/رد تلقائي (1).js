...
'*بوت ڤينوم تحت امرك*'
 ...
 }else if (/^لايت من عمك|لايت عمك$/i.test(m.text)) { 
     responses = [ 
'*لايت اككيد😩❤‍🔥*'
     ]; 
   }else if (/^لايت هل انت مرتبط$/i.test(m.text)) { 
     responses = [ 
'*لا ولا أريد الارتباط🏌🏻‍♂💔*'
   ]; 
   }else if (/^لايت تحبني؟|بوت تحبني$/i.test(m.text)) { 
     responses = [ 
'*اموت فيك 🌚💔*',
'*اكرهك🙂💔*',
'*احبك نص حب 🙃💔*',
]; 
   }else if (/^لايت تكرهني؟$/i.test(m.text)) { 
     responses = [ 
'*ماعاش من يكرهكك حبي 🙁*',
...
'*ااي اكرهك🙄*',   ]; 
   ...
   }else if (/^لايت من وين انت؟$/i.test(m.text)) { 
     responses = [ 
'❤🇪🇬مصر'
     ]; 
